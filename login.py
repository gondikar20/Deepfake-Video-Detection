...
# title=tk.Label(Login_frame, text="Login Here", font=("Algerian", 30, "bold","italic"),bd=2,bg="#6495ED",fg="black")
# title.place(x=00,y=0,width=290)


logolbl=tk.Label(Login_frame,text="Login Here", font=("Algerian", 30, "bold","italic"),bd=2,bg="#6495ED",fg="black").grid(row=0,columnspan=2,pady=20)
